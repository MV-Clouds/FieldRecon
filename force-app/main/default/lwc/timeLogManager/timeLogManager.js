...
import getJobRelatedMoblizationDetails from '@salesforce/apex/TimeLogManagerController.getJobRelatedMoblizationDetails';
import getTimeSheetEntryItems from '@salesforce/apex/TimeLogManagerController.getTimeSheetEntryItems';
...
import deleteTimesheetEntriesBulk from '@salesforce/apex/TimeLogManagerController.deleteTimesheetEntriesBulk';
import saveTimesheetEntryInlineEdits from '@salesforce/apex/TimeLogManagerController.saveTimesheetEntryInlineEdits';

export default class TimeLogManager extends NavigationMixin(LightningElement) {
    @track jobDetailsRaw;
